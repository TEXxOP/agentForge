...
## 0:00 to 0:40 - What the system is (Architecture)
...
## 0:40 to 1:00 - Why tests and traces do not cover this
...
## 2:30 to 3:15 - Break it yourself (Attack lab)
...
## 3:15 to 4:00 - The release gate, and the miss we kept (Evidence)
...
## 4:00 to 4:40 - Prove the controls are load-bearing (Policy)
